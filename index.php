    ...
    <body class="theme-bg">
        ...
        <main>
            ...
            <section id="service" class="services-area pt-120 pb-50">
				<div class="container">
                    <div class="row justify-content-center">
                        <?php 
                        $select_active_service_query = "SELECT * FROM services WHERE service_status = 'active'";
                        $select_active_service_query_implementation = mysqli_query($db_connect,$select_active_service_query);
                        ?>
					...
					<div class="row">
						<?php
                        foreach ($select_active_service_query_implementation as $services ): 
                        ?>
            ...
            <section id="portfolio" class="portfolio-area primary-bg pt-120 pb-90">
                <div class="container">
                    <?php 
                    $portfolio_retrieve_query = "SELECT * FROM portfolios WHERE portfolio_status = 'active'";
                    $portfolio_retrieve_query_execution = mysqli_query($db_connect, $portfolio_retrieve_query);
                    ?>
                    ...
                    <?php foreach ($portfolio_retrieve_query_execution as $value): ?>
                        <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
								<div class="speaker-thumb">
									<img src="backend/uploads/portfolio_images/<?=$value['portfolio_image'];?>" alt="img">
								</div>
								<div class="speaker-overlay">
									<span> <?=$value['portfolio_category']; ?> </span>
									<h4><a href="portfolio-single.html"> <?=$value['portfolio_title'];?> </a></h4>
        ...
        <script src="assets/frontend/assets/frontend/js/popper.min.js"></script>
